...
print("https://github.com/cipher-ghost-amf")
...
if __name__ == '__main__':
    def printLow(Str):
        for char in Str:
            ...
            sleep(.01)
    printLow(f'''{r}++++++++++++++++++++++++++++
{w} Telegram : T.me/ghost_hub1_bot
{g} +++++++++++++++++++++++++

{y}Info:
    {g}[+] {y}Coder: {r} @cipher_ghost_AMF
    {g}[+] {y}instagram {p} ✖️✖️✖️✖️
    {g}[+] {y}telegram {b} ghost_hub1_bot
    {g}[+] {y}Github: {w} https://github.com/cipher-ghost-amf
